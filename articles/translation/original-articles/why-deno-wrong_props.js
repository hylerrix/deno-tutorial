    ...
    'toc': React.createElement("nav", { key: "0", className: "toc" },
        React.createElement("ol", null,
            React.createElement("li", null,
                React.createElement("a", { href: "#deno-vs-node---there-is-actually-competition" }, "Deno vs Node - there IS actually competition")),
            React.createElement("li", null,
                React.createElement("a", { href: "#why-try-deno" }, "Why try Deno?")),
            React.createElement("li", null,
                React.createElement("a", { href: "#where-deno-overdid" }, "Where Deno overdid?"),
                React.createElement("ol", null,
                    React.createElement("li", null,
                        React.createElement("a", { href: "#secure-runtime-environment-by-default" }, "Secure runtime environment by default")),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#typescript-support-baked-in" }, "TypeScript support baked in")),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#promises-all-the-way-down" }, "Promises all the way down")),
                    React.createElement("li", null,
                        React.createElement("a", { href: "#hasta-la-vista-npm" }, "hasta la vista, npm")))),
            React.createElement("li", null,
                React.createElement("a", { href: "#conclusion" }, "Conclusion")))),
    'author': "hylerrix",
    'contributors': [
        "hylerrix"
    ],
