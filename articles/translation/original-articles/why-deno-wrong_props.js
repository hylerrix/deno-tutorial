...
export default {
    ...
    'toc': React.createElement("aside", { dangerouslySetInnerHTML: {
            __html: '<nav class="toc"><ol><li><a href="#deno-vs-node---there-is-actually-competition">Deno vs Node - there IS actually competition</a></li><li><a href="#why-try-deno%3F">Why try Deno?</a></li><li><a href="#where-deno-overdid%3F">Where Deno overdid?</a><ol><li><a href="#secure-runtime-environment-by-default">Secure runtime environment by default</a></li><li><a href="#typescript-support-baked-in">TypeScript support baked in</a></li><li><a href="#promises-all-the-way-down">Promises all the way down</a></li><li><a href="#hasta-la-vista%2C-npm">hasta la vista, npm</a></li></ol></li><li><a href="#conclusion">Conclusion</a></li></ol></nav>'
        } })
};
